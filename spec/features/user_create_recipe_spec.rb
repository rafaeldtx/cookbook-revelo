...
feature 'user create recipe' do
  ...
  scenario 'and edit' do
    ...
    recipe = Recipe.create(title: 'Bolo de Cenoura', recipe_type: recipe_type, cuisine: cuisine, ingredients: 'Trigo, Ovos e Cenoura', difficulty: 'Médio', cook_time: 50, cook_method: 'Misture os ingredientes')
